    ...
    <div className="container education-container mt-5">
      <div className="p-4 shadow rounded bg-white">
        ...
        <div className="mb-4">
          ...
          <p className="mb-1"><strong>Talahib Elementary School</strong> <span className="text-muted">(2009–2015)</span></p>
        ...
        <div className="mb-4">
          ...
          <p className="mb-1"><strong>Bigaa Integrated National High School</strong> <span className="text-muted">(2015–2019)</span></p>
          <ul className="education-list">
        ...
        <div>
          ...
          <p className="mb-1"><strong>Pamantasan ng Cabuyao</strong> <span className="text-muted">(2021–Present)</span></p>
          <ul className="education-list">
